---
title: "GSE264278 Bleomycin Lung PreProcessing"
author: "Kendrix Kek"
date: "2025-02-14"
output:
  html_document:
...
supp_file_path = "~/Documents/Work/UnityHealth/Data_Projects/scRNAseq_LungFibrosisAnalysis/GSE264278/"
...
filtering_summary <- data.frame(cell_number_remaining = c(ncol(merged_seurat),
                                ...
                                filter_criteria = c("Pre-filtering counts",
                                                    ...
                                                    "Filter: Complexity (log10GenesPerUMI > 0.6)",
...
```{r save objects}
save(seurat_cluster, 
     file = "~/Documents/Work/UnityHealth/Data_Projects/scRNAseq_LungFibrosisAnalysis/GSE264278/data/preprocessed_seurat_obj.RData")
```
