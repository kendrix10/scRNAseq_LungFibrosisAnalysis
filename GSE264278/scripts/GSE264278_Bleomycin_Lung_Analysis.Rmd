...
project_path = "/Users/kendrix/Documents/Work/UnityHealth/Data_Projects/scRNAseq_LungFibrosisAnalysis/GSE264278/"
...
# Define COL1A1 expression based on 0 expression threshold.
summary_table <- summary_table %>% mutate(Col1a1_expressed = Col1a1 > 0)
...
celltype_timepoint_counts_mice <- (summary_table %>% 
                                     ...
                                     summarise(celltype_count = n(),
                                               ...
                                               Col1a1_total_exprs = sum(Col1a1_expressed),
                                               .groups = "drop") %>%
...
celltype_timepoint_counts_mice <- (celltype_timepoint_counts_mice %>%
                                     mutate(celltype_by_totalcells = 
                                            ...
                                            Col1a1_by_totalcells =
                                              (Col1a1_total_exprs/total_cells_timepoint)*100,
                                            Col1a1_by_celltypes =
                                              (Col1a1_total_exprs/celltype_count)*100))
...
summary_stats <- (celltype_timepoint_counts_mice %>%
                    ...
                    summarise(
                      ...
                      mean_percent_col1a1_total = mean(Col1a1_by_totalcells),
                      sd_percent_col1a1_total = sd(Col1a1_by_totalcells),
                      mean_percent_col1a1_celltype = mean(Col1a1_by_celltypes),
                      sd_percent_col1a1_celltype = sd(Col1a1_by_celltypes),
                      n_mice = n(),
                      ...
                      se_percent_col1a1_total = sd_percent_col1a1_total / sqrt(n_mice),
                      se_percent_col1a1_celltype = sd_percent_col1a1_celltype / sqrt(n_mice),
                      .groups = "drop"
                    ))
...
vln_seu <- subset(seurat_obj, 
                  idents = c("AT1", "AT2", "AT2 proliferating",
                             "Endothelial cells", "Endothelial lymphatic",
                             "Fibroblasts", "Fibromyocytes",
                             "Immune", "Pericytes", "VSMCs"), 
                  invert = FALSE)
