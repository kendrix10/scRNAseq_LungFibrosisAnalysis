---
title: "GSE135893 IPF Lung Analysis"
author: "Kendrix Kek"
date: "2025-11-19"
output:
  html_document:
...
obj <- readRDS(file = "Z:/Kendrix/IPF_Lung/GSE135893/processed_data/preprocessed_seurat_obj.rds")
```
...
for (col in columns_incl) {
  p <- ggplot(metadata, aes_string(x = col)) +
    ...
    labs(title = paste("Distribution of", col, "in GSE135893"),
         x = col,
         y = "Count") +
    theme_bw()
